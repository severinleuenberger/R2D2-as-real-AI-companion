...
See: **[`010_PERSON_RECOGNITION_STATUS.md`](010_PERSON_RECOGNITION_STATUS.md)** for complete perception pipeline, face recognition, and audio notification system including:
...
OAK-D Lite Camera (this document)
    ↓
Complete Person Recognition & Audio System (010_PERSON_RECOGNITION_STATUS.md)
```
